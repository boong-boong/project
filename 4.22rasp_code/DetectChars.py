...
def recognizeCharsInPlate(imgThresh, listOfMatchingChars):
    ...
    po1_x = listOfMatchingChars[0].intBoundingRectX
    po1_y = listOfMatchingChars[0].intBoundingRectY
    po2_x = 0
    po2_y = 0
    ...
    for currentChar in listOfMatchingChars:                                         # for each char in plate
        ...
        po2_x = currentChar.intBoundingRectX + currentChar.intBoundingRectWidth
        po2_y = currentChar.intBoundingRectY + currentChar.intBoundingRectHeight

    # end for
    
    imgThresh = imgThresh[0:imgThresh.shape[0], (po1_x):(po2_x)]
    cv2.imwrite("test.png", imgThresh)
    strChars = pytesseract.image_to_string(Image.open('test.png'), lang='car2')
